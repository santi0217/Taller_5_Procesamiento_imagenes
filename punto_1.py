...
#
#  Descripción: Este programa consiste en leer 20 imágenes de una carpeta del ordenador las cuales en el primer caso
#               se tomaron con la cámara de un computador portátil y en el segundo caso se tomaron con la cámara de
#               un celular; estas imágenes se analizan una a una para reconocer el patrón de las esquinas de los cuadros
#               del tablero de ajedrez para así poder hallar los parámetros de calibración de la cámara y de la misma
#               manera hallar los valores de distorsión de la imagen. Hecho esto se procede a salvar estos datos de
#               calibración en 2 archivos JSON.
#               Adicionalmente, se crean 2 archivos JSON con la matriz K hallada con la calibración de las imágenes
#               tomadas por el celular y los datos necesarios para cada uno de ellos en el punto 2.
#
