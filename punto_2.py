...
#
#  Descripción: Este programa consiste en leer 2 archivos JSON los cuales contienen información necesaria para proyectar
#               la cámara calibrada del celular utilizado, pero desde ciertos ángulos; con estos datos se proyecta la
#               cámara en ambos casos y se traza un cubo según los parámetros de cada proyección con el fin de mostrar
#               este cubo visto desde diferentes ángulos donde se pondría dicha cámara.
#
